    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invited_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='members', to='tortoise_api.Invite')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
        ...
        migrations.AddField(
            model_name='invite',
            name='creator',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='tortoise_api.Member'),
        ),
        migrations.CreateModel(
            name='Infraction',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('muted_role_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('verified_role_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('trusted_role_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('new_member_role', utils.misc.DiscordIDField(blank=True, null=True)),
                ('guild', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='roles_special', to='tortoise_api.Guild')),
            ],
        ),
        migrations.CreateModel(
            name='GuildOption',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('welcome_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('announcements_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('react_for_roles_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('mod_mail_report_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('bug_reports_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('code_submissions_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('suggestions_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('system_log_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ...
                ('successful_verifications_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('verification_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('member_count_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
                ('general_channel_id', utils.misc.DiscordIDField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='admin', to='tortoise_api.User')),
            ],
        ),
        migrations.CreateModel(
