...
class Oauth(object):
    ...
    client_secret = "xaaNctPhb2Lta_Fmw4pY9b4UUB0y8oYC" # settings.OAUTH_CLIENT_SECRET
    scope = "identify%20email"
    redirect_uri = "http://127.0.0.1:8000/verification/" # "https://www.tortoisecommunity.com/verification/handlers/"
