...
class ServerUtils(models.Model):
	...
	status = JSONField(null=True,default=default_status) 
	Github-Micorservice = JSONField(null=True,default=default_json)
	Status-Microservice = JSONField(null=True,default=default_json)
